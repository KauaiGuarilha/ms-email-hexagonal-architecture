package com.ms.email.adapters.inbound.controller;
...
public class EmailController {
    ...
    public ResponseEntity<Object> getOneEmail(@PathVariable(value="emailId") UUID id){
        Optional<Email> emailModelOptional = emailServicePort.findById(id);
